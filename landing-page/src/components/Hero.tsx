...
const Hero = () => {
  return (
    <section className="bg-white dark:bg-[#0a0a0b] text-gray-900 dark:text-white min-h-[90vh] flex flex-col-reverse lg:flex-row items-center justify-center lg:justify-between px-5 lg:px-14 py-10 gap-10 transition-colors duration-300">
      ...
      <div className='lg:w-1/2 w-full relative flex justify-center'>
        <div className="relative group">
          <div className="absolute -inset-4 bg-[#e6005c]/20 blur-[80px] rounded-full opacity-0 dark:opacity-50 group-hover:opacity-80 transition-opacity" />
          
          <img 
            src={img} 
            alt="Mestre das Comandas Dashboard" 
            className="relative z-10 rounded-3xl w-[320px] h-[320px] md:w-[550px] md:h-[420px] object-cover border-4 border-gray-100 dark:border-white/10 shadow-2xl transition-all" 
          />
    
          <div className="absolute -top-4 -right-4 z-20 bg-white dark:bg-[#1a1a1c] text-gray-900 dark:text-white text-xs md:text-sm font-bold px-5 py-3 rounded-2xl flex items-center gap-2 shadow-2xl border border-gray-100 dark:border-white/5"> 
            <RiDashboard3Line className="text-[#e6005c] text-xl"/> Painel Admin
          </div>
          
          <div className="absolute top-1/2 -left-10 z-20 bg-white dark:bg-[#1a1a1c] text-gray-900 dark:text-white text-xs md:text-sm font-bold px-5 py-3 rounded-2xl flex items-center gap-2 shadow-2xl border border-gray-100 dark:border-white/5">
            <RiDeviceLine className="text-[#e6005c] text-xl"/> App Garçom
          </div>

          <div className="absolute -bottom-4 right-4 z-20 bg-white dark:bg-[#1a1a1c] text-gray-900 dark:text-white text-xs md:text-sm font-bold px-5 py-3 rounded-2xl flex items-center gap-2 shadow-2xl border border-gray-100 dark:border-white/5">
