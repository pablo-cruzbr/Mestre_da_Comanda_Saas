...
const Navbar = () => {
  return (
    <header className="flex items-center justify-between py-4 px-5 lg:px-14 bg-white dark:bg-[#0a0a0b] border-b border-gray-100 dark:border-gray-800 transition-colors duration-300 sticky top-0 z-50 backdrop-blur-md bg-opacity-90 dark:bg-opacity-90">
